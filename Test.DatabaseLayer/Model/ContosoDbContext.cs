...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=DESKTOP-8MEVUBJ\\SQLEXPRESS;Database=Contoso;User Id=sa;Password=magic;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Test4>(entity =>
            {
                ...
                entity.HasOne(d => d.Test2)
                    .WithMany(p => p.Test4)
                    .HasForeignKey(d => d.Test2Id)
                    .HasConstraintName("FK_Test1_Test4");
            });
        }
    }
}
